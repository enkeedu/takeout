...
export function TemplateMingFull({
  restaurant,
  menu,
  reviews,
  hours,
      ...
      <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen bg-[#FFFEFD]">
        ...
        <div className="relative mx-auto max-w-[1760px] px-6 py-10 space-y-10">
          ...
          <section className="full-bleed section-angled relative overflow-hidden border border-[#e6dfd8] bg-black text-white">
            ...
            <div className="relative mx-auto max-w-[1760px] px-6 py-10 text-center">
              ...
              <p className="mt-3 text-sm text-white/80">
                We help with gatherings, office trays, and special dinners.
              </p>
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                <a
                ...
                <a
                  href="#order"
                  className="border border-white/70 px-6 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white hover:bg-white hover:text-black"
                >
                  Order Pickup
                </a>
              </div>
